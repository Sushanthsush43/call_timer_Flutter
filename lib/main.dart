...
import 'package:call_app/extensions_static.dart';
import 'package:call_app/flutter_phone_state.dart';
import 'package:call_app/phone_event.dart';
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [
                    Color(0xFF0EAE57), // rgba(14, 174, 87, 1) -> #0eae57
                    Color(0xFF0C7475), // rgba(12, 116, 117, 1) -> #0c7475
                    // rgba(154, 27, 69, 1) // New color #bbb // Existing color // rgba(36,163,190,1)
                  ],
...
class _CallCard extends StatelessWidget {
  ...
  const _CallCard({Key? key, required this.phoneCall}) : super(key: key);
